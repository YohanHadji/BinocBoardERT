...
typedef enum
{
    XSENS_EVT_TEMPERATURE = 0,  //0 
    XSENS_EVT_UTC_TIME,         //1
    XSENS_EVT_PACKET_COUNT,     //2
    XSENS_EVT_TIME_FINE,        //3
    XSENS_EVT_TIME_COARSE,      //4  
    XSENS_EVT_QUATERNION,       //5
    XSENS_EVT_EULER,            //6
    XSENS_EVT_ROT_MATRIX,       //7
    XSENS_EVT_PRESSURE,         //8
    XSENS_EVT_DELTA_V,          //9
    XSENS_EVT_DELTA_Q,          //10
    XSENS_EVT_ACCELERATION,     //11
    XSENS_EVT_FREE_ACCELERATION,//12
    XSENS_EVT_ACCELERATION_HR,  //13
    XSENS_EVT_RATE_OF_TURN,     //14
    XSENS_EVT_RATE_OF_TURN_HR,  //15
    XSENS_EVT_GNSS_PVT_PULSE,   //16
    XSENS_EVT_GNSS_PVT_DATA,    //17
    XSENS_EVT_RAW_ACC_GYRO_MAG_TEMP,//18
    XSENS_EVT_RAW_GYRO_TEMP,    //19
    XSENS_EVT_MAGNETIC,         //20
    XSENS_EVT_STATUS_BYTE,      //21
    XSENS_EVT_STATUS_WORD,      //22
    XSENS_EVT_DEVICE_ID,        //23
    XSENS_EVT_LOCATION_ID,      //24
    XSENS_EVT_POSITION_ECEF,    //25
    XSENS_EVT_LAT_LON,          //26
    XSENS_EVT_ALTITUDE_ELLIPSOID,//27
    XSENS_EVT_VELOCITY_XYZ,     //28
} XsensEventFlag_t;
